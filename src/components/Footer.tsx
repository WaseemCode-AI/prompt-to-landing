      ...
      <div className="container px-4 md:px-6 py-16">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="text-muted-foreground">
              AI-powered landing page generator that turns your ideas into stunning designs in seconds.
            </p>
        ...
        <div className="mt-16 pt-6 border-t flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground mb-4 md:mb-0">
            &copy; {currentYear} LandingPage. All rights reserved.
          </p>
          <div className="flex items-center">
            <span className="text-sm text-muted-foreground mr-2">Powered by</span>
            <Zap className="h-4 w-4 text-purple-500" />
            <span className="text-sm font-medium ml-1">AI Magic</span>
          </div>
        </div>
      </div>
    </footer>
